			...
			<div data-role="content" id="search_form_div">
				...
				<h3>Search Accessible Tube Stations</h3>
						  <form action="/public/ajax/tube.php" method="get" data-ajax="false" id="search_form">
							  ...
							  <a href="#event_div" data-mini="true" data-icon="arrow-r" data-iconpos="right" data-theme="a" id="quick_places_a" data-role="button" data-transition="slideup">Choose Location from an event</a>
