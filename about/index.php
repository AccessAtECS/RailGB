	...
	<body>
		<div class="container" id="container">
			<div class="page-header">
				<h1><img src="/railgb/img/pins/rail-red.png" /> RailGB <small>About the Project</small> <a class="btn pull-right" href="/railgb">Back to National Rail Map</a></h1>
			</div>
			
			<div class="row-fluid">
				<div class="span4">
					<img src="/railgb/img/theme/class-377-southampton.jpeg" alt="class 377 southern service train" />
				</div>
